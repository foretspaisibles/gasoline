(* Test_rcorder -- Test rcorder

Author: Michael Grünewald
Date: Sun Sep 21 00:29:03 CEST 2014
...
let component name require provide = {
...
let bootstrap comp =
  print_endline comp.Application.Component.name

let register (name, provide, require) =
  Application.Component.register ~bootstrap
    (component name require provide)
