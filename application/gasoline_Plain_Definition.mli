(* Gasoline_Plain_Definition -- Basic definitions for plain applications
...
module Data : Gasoline_Generic_Definition.DATA
  with type word = char
...
buffers. *)
module Buffer : Gasoline_Generic_Definition.BUFFER
...
sig
  ...
  [Gasoline_Generic_message.Scribe] functor, for instance. *)
...
module MessageDB : Gasoline_Generic_Definition.MESSAGEDB
